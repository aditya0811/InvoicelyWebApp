    ...
    <div class="page-add-client">
        ...
        <nav class="breadcrumb" aria-label="breadcrumbs">
            <ul>
                ...
                <!-- This is same router link value that we have in Client.vue for EditClient. We added aria-current for styling -->
        ...
        <div class="columns is-multiline">
            ...
            <div class="column is-6">
                ...
                <div class="field">
                    <label> Email </label>
                    <div class="control">
                        <!-- Here we are using type as email to use bulma for validations -->
...
export default {
    ...
    methods : {
        getClient() {
            ...
            // Use ` for quoting url, if you are using a variable inside that.
            axios
        ...
        submitForm() {
            ...
            axios
                ...
                .then(response =>{
                    toast ({
                        message: 'The client changes were saved',
                        type : 'is-success',
