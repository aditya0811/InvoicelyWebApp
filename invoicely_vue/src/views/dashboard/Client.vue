    ...
    <div class="page-client">
        ...
        <div class="columns is-multiline">
            <div class="column is-12">
                ...
                <router-link :to="{ name : 'EditClient', params:{ id : client.id }}" class="button is-light mt-4">Edit client</router-link> 
            </div>
            <div class="column is-12">
                ...
                <p v-if="client.zipcode || client.place">{{ client.place }} {{ client.zipcode }}</p>
